...
my $command = "$gridss_sh --steps All --jvmheap $heap_size --otherjvmheap $heap_size --reference $ref --output $out_prefix.vcf.gz --assembly $out_prefix.gridss.assembly.bam --jar $gridss_jar --blacklist $black_list --threads $cores $input_bam 2>$out_prefix.gridss.log" if ($gridss_sh !~ /\.sh$/);
$command = "$gridss_sh --steps All --jvmheap $heap_size --otherjvmheap $heap_size --reference $ref --output $out_prefix.vcf.gz --assembly $out_prefix.gridss.assembly.bam --jar $gridss_jar --threads $cores $input_bam 2>$out_prefix.gridss.log" if ($black_list eq '') and ($gridss_sh !~ /\.sh$/);
$command = "$gridss_sh --steps All --jvmheap $heap_size --reference $ref --output $out_prefix.vcf.gz --assembly $out_prefix.gridss.assembly.bam --jar $gridss_jar --blacklist $black_list --threads $cores $input_bam 2>$out_prefix.gridss.log" if ($gridss_sh =~ /\.sh$/);
$command = "$gridss_sh --steps All --jvmheap $heap_size --reference $ref --output $out_prefix.vcf.gz --assembly $out_prefix.gridss.assembly.bam --jar $gridss_jar --threads $cores $input_bam 2>$out_prefix.gridss.log" if ($black_list eq '') and ($gridss_sh =~ /\.sh$/);
